...
<template>
  <div class="p-4">
    <div class="mb-4">
      <h2 class="text-xs mb-2 opacity-40">Subline 2</h2>
      <input
        @change="saveContent"
        v-model="componentContent.subline2"
        type="text"
    ...
    <div class="mb-4">
      <h2 class="text-xs mb-2 opacity-40">Date</h2>
      <input
        @change="saveContent"
        v-model="componentContent.date"
        type="text"
        placeholder="e.g. 15. März 2024"
        class="w-full rounded-sm pl-1 bg-transparent border border-darkOffwhite border-opacity-20"
      />
    </div>
    <div class="mb-4">
