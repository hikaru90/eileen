    ...
    <div class="flex items-center gap-2" :class="[{ 'opacity-60': !isRealProperty }]">
      <template v-for="padding in state.paddings">
        <div>
          ...
          <input @change="compileAndSetProperty" v-model="padding.value" type="number" class="w-12 rounded-sm pl-1 bg-transparent border border-darkLilac border-opacity-20">
