...
import { defineComponent, reactive, onUnmounted, mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="max-container h-full relative z-10"><div class="h-full flex items-center justify-center py-16 md:py-24"><div class="mt-10"><h2 class="font-heading text-lg sm:text-xl md:text-3xl lg:text-4xl mb-16 text-center text-coffee">${ssrInterpolate(props.component.content.heading)}</h2><div class="flex flex-col lg:flex-row gap-16 items-center lg:items-start"><div class="max-w-[44rem]"><p class="markdown text-coffee">${_ctx.$mdRenderer.set({ html: true }).render(props.component.content.text)}</p>`);
...
//# sourceMappingURL=MyWork-fddaab26.mjs.map
