...
import { u as useAuthStore, d as usePocketBase, f as useContentStore, b as useSidebarStore } from './server.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-black text-darkOffwhite py-4" }, _attrs))}><div class="max-container"><div class="flex items-center justify-between"><div>${ssrInterpolate((_b = (_a = unref(authStore)) == null ? void 0 : _a.user) == null ? void 0 : _b.name)}</div><div class="flex items-center"><button class="rounded-sm border border-lightBlue px-3 py-1 mx-2"> Home </button><button class="rounded-sm border border-lightBlue px-3 py-1 mx-2"> Debug </button><button class="rounded-sm border border-lightBlue px-3 py-1 mx-2"> Buchungen verwalten </button></div></div></div>`);
...
//# sourceMappingURL=Footer-d530e466.mjs.map
