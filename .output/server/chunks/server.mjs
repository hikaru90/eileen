...
const _routes = [
  {
    ...
    component: () => import('./_...slug_-2ecdc2ac.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./bak-index-8791d276.mjs').then((m) => m.default || m)
  },
  {
