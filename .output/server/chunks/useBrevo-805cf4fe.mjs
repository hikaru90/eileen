  ...
  const templates = [
    {
      ...
      Liebe Gr\xFC\xDFe aus dem Backend<br />
      </body></html>`
    },
    {
    ...
    },
    {
      ...
      ${(formData == null ? void 0 : formData.place) === "inPerson" ? "Ich freue mich, Sie bald pers\xF6nlich in Stuttgart zu empfangen.<br /><br />" : "Ich sende Ihnen den entsprechenden Link f\xFCr die Durchf\xFChrung Ihres Onlinetermins im Vorfeld zu.<br /><br />"}
...
//# sourceMappingURL=useBrevo-805cf4fe.mjs.map
