...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ], "fixed z-30 bg-white top-0 left-0 w-full h-full transform transition-all select-none"])}"><div class="max-container w-full"><div class="flex items-center justify-between py-6 mb-10"><div class="font-heading text-2xl text-coffee">`);
      ...
      _push(`</div></div></div><div class="absolute top-0 left-0 w-full shadow-sm z-20 text-white"><div class="max-container w-full"><div class="flex items-center justify-between py-6"><div class="font-heading text-2xl text-coffee">`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Eileen George `);
...
//# sourceMappingURL=UpButton-c8a27a9c.mjs.map
