import _sfc_main$a from './nuxt-icon-5eb3d977.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex justify-center w-full"><button aria-label="Termin buchen" type="submit" class="border-2 border-gold bg-gold rounded text-offwhite flex items-center px-3 py-2 mb-20"><div class="text-coffee font-bold">Termin buchen</div><div class="flex items-center justify-center bg-white rounded-full ml-2 w-4 h-4">`);
      _push(ssrRenderComponent(_component_nuxt_icon, {
        name: "icon-check",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(state).formSubmitted) {
        ...
        ssrRenderList(unref(state).steps, (step, index) => {
          ...
          _push(`</div></div><div class="${ssrRenderClass([[unref(state).currentStep === step.id ? "text-coffee font-bold" : "text-lightGrey"], ""])}" class="">${ssrInterpolate(step.name)}</div></button>`);
        });
        _push(`<!--]--></div>`);
...
//# sourceMappingURL=BookingCalendar-3e04ee4b.mjs.map
