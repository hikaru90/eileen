...
const getTemplate = (templateName, formData) => {
  ...
  const templates = [
    ...
    },
    {
      ...
      vielen Dank f\xFCr Deine Terminbuchung, die ich Dir hiermit gerne best\xE4tige.<br /><br />

      ${(formData == null ? void 0 : formData.place) === "inPerson" ? "Ich freue mich, Dich bald pers\xF6nlich zu empfangen.<br /><br />" : "Ich sende Dir den entsprechenden Link f\xFCr die Durchf\xFChrung Deines Onlinetermins im Vorfeld zu.<br /><br />"}
...
//# sourceMappingURL=useBrevo-e20f6334.mjs.map
