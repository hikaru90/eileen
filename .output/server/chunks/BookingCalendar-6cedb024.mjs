...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_FormInputLabel = _sfc_main$7;
      const _component_FormInputError = _sfc_main$6;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-0c5b6ad4><div class="${ssrRenderClass(__props.innerClass)}" data-v-0c5b6ad4><div class="relative" data-v-0c5b6ad4>`);
      _push(ssrRenderComponent(_component_FormInputLabel, {
        label: props.label,
        class: "text-left"
      }, null, _parent));
...
//# sourceMappingURL=BookingCalendar-6cedb024.mjs.map
