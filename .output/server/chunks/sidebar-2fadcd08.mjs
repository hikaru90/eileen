import { _ as __nuxt_component_0, a as _sfc_main$3 } from './Footer-8d273b87.mjs';
import { _ as _sfc_main$1, a as _sfc_main$2 } from './UpButton-c8a27a9c.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="${ssrRenderClass([[{ "overflow-x-hidden": !unref(authStore).token }], "flex flex-col flex-grow relative"])}">`);
...
//# sourceMappingURL=sidebar-2fadcd08.mjs.map
