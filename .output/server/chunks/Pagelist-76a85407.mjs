    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(data).pending) {
        ...
        ssrRenderList(unref(data).pagelist, (page) => {
          _push(`<div class="flex items-center justify-between p-6 hover:bg-black hover:bg-opacity-5 rounded-md cursor-pointer"><div class="flex items-center">`);
...
//# sourceMappingURL=Pagelist-76a85407.mjs.map
