...
import { u as useBrevo } from './useBrevo-330c3be0.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import '@unhead/vue';
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(state).selectedDate) {
        _push(`<h2 class="font-bold text-md mb-10 mt-6"> Hier k\xF6nnen Sie ganz bequem \xFCber das Online Buchungstool einen Erst- oder Folgetermin buchen.<br><br> W\xE4hlen Sie ein Datum und eine passende Uhrzeit aus. </h2>`);
      } else {
        _push(`<!--[-->`);
        if (unref(state).timeslots.length === 0) {
          _push(`<!--[--> Am <span class="font-bold">${ssrInterpolate(new Date(unref(state).selectedDate).toLocaleDateString("de-DE", {}))}</span> stehen Ihnen leider keine freien Termine zur Verf\xFCgung. <!--]-->`);
        } else {
          _push(`<!--[--><div class="mb-3"> Am <span class="font-bold">${ssrInterpolate(new Date(unref(state).selectedDate).toLocaleDateString("de-DE", {}))}</span> stehen Ihnen folgende Termine zur Verf\xFCgung: </div><div class="flex items-center flex-wrap gap-2"><!--[-->`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full flex items-center px-4" }, _attrs))}><h2 class="font-bold mr-2">`);
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</h2><div class="border-b border-black flex-grow"></div></div>`);
}
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["text-xs font-bold ml-2", [{ "mb-1": props.label }]]
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
      ...
      if (state.touched) {
        ...
        if ((_b = props.validation) == null ? void 0 : _b.includes("email")) {
          if (((_c = props.modelValue) == null ? void 0 : _c.includes("@")) === false) {
            errors2.push("Bitte geben Sie eine g\xFCltige E-Mail-Adresse ein");
          }
        }
      }
      return errors2;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: __props.innerClass }, _attrs))}><div class="relative">`);
      _push(ssrRenderComponent(_component_FormInputLabel, {
        label: props.label,
        class: "text-left"
      }, null, _parent));
      _push(`<div class="w-full relative"><input autocomplete="disabled"${ssrRenderAttr("type", __props.type)}${ssrRenderAttr("placeholder", __props.placeholder)} class="${ssrRenderClass([props.inputClass, "fieldTarget"])}"${ssrRenderDynamicModel(__props.type, unref(data), null)}><div class="absolute top-1/2 right-2 transform -translate-y-1/2">`);
      if (unref(isValid)) {
  ...
  setup(__props, { emit }) {
    ...
    const errors = computed(() => {
      ...
      if (state.touched) {
        if ((_a = props.validation) == null ? void 0 : _a.includes("required")) {
          if (!props.modelValue) {
            errors2.push("W\xE4hlen Sie bitte eine Option");
          }
        }
      }
      return errors2;
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full relative"><textarea autocomplete="disabled"${ssrRenderAttr("type", __props.type)}${ssrRenderAttr("placeholder", __props.placeholder)} class="fieldTarget w-full p-2 border border-grey rounded">${ssrInterpolate(unref(data))}</textarea><div class="absolute top-2 right-2">`);
      if (unref(isValid)) {
        _push(`<div class="bg-green bg-opacity-40 rounded">`);
        _push(ssrRenderComponent(_component_nuxt_icon, {
          name: "icon-check",
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
      ...
      if (state.touched) {
        if ((_a = props.validation) == null ? void 0 : _a.includes("required")) {
          if (props.modelValue === false) {
            errors2.push("Bitte best\xE4tigen Sie dieses Feld");
          }
        }
      }
      return errors2;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_FormInputLabel = _sfc_main$7;
      const _component_FormInputError = _sfc_main$6;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-95f14d2d><div class="${ssrRenderClass(__props.innerClass)}" data-v-95f14d2d><div class="relative" data-v-95f14d2d>`);
      _push(ssrRenderComponent(_component_FormInputLabel, {
        label: props.label,
        class: "text-left"
      }, null, _parent));
      _push(`<div class="w-full relative" data-v-95f14d2d><div class="flex items-center gap-4" data-v-95f14d2d><label class="switch ml-02 my-01 flex-shrink-0" data-v-95f14d2d><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(data)) ? ssrLooseContain(unref(data), null) : unref(data)) ? " checked" : ""} class="fieldTarget" data-v-95f14d2d><span class="slider" data-v-95f14d2d></span></label><div class="text-left text-sm flex-grow" data-v-95f14d2d>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></div></div></div></div>`);
      if (!unref(isValid)) {
        _push(`<!--[-->`);
        ssrRenderList(unref(errors), (error, index) => {
          _push(`<div data-v-95f14d2d>`);
          _push(ssrRenderComponent(_component_FormInputError, { error }, null, _parent));
          _push(`</div>`);
        });
        _push(`<!--]-->`);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-95f14d2d"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_nuxt_icon = _sfc_main$a;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center text-center" }, _attrs))}><div class="mb-4">Sie haben folgenden Termin ausgew\xE4hlt:</div><div class="font-bold text-xl border-2 rounded border-gold inline-block px-4 py-1 mb-10">${ssrInterpolate(unref(timeslotString))}</div><div class="w-full lg:w-2/3 mb-10"> Um Ihre Buchung abzuschlie\xDFen, ben\xF6tige ich noch ein paar Informationen von Ihnen. F\xFCllen Sie bitte untenstehendes Formular aus. </div><form class="w-full lg:w-2/3 flex flex-wrap -m-2">`);
      ...
      _push(ssrRenderComponent(_component_FormInputTextarea, {
        ...
        placeholder: "Bitte tragen Sie die gew\xFCnschte Rechnungsadresse ein",
      ...
      _push(`<div class="flex justify-center w-full"><button aria-label="Termin buchen" type="submit" class="border-2 border-gold bg-gold rounded text-offwhite flex items-center px-3 py-2 mb-20"><div class="text-black font-bold">Termin buchen</div><div class="flex items-center justify-center bg-white rounded-full ml-2 w-4 h-4">`);
      _push(ssrRenderComponent(_component_nuxt_icon, {
        name: "icon-check",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(state).formSubmitted) {
        ...
        if (unref(state).success) {
          _push(`<div class="flex justify-center my-20"><div class="w-full lg:w-2/3 font-bold border-2 rounded border-green bg-green bg-opacity-40 inline-block px-6 py-4 mb-10 text-center"> Vielen Dank f\xFCr Ihre Buchung. <br> Ich melde mich zeitnah per E-Mail bei Ihnen. </div></div>`);
        } else {
          _push(`<div class="flex justify-center my-20"><div class="w-full lg:w-2/3 font-bold border-2 rounded border-red bg-red bg-opacity-40 inline-block px-6 py-4 mb-10 text-center"> Bei der \xDCbermittlung Ihrer Daten ist leider ein Fehler aufgetreten. <br>Versuchen Sie es bitte erneut. Sollte das Problem weiterhin bestehen, schreiben Sie mir bitte eine Mail an <a href="mailto:kontakt@eileengeorge.de" class="underline">kontakt@eileengeorge.de</a>. </div></div>`);
        }
        _push(`<!--]-->`);
      } else {
        _push(`<!--[--><div class="flex items-center justify-center gap-10"><!--[-->`);
        ssrRenderList(unref(state).steps, (step, index) => {
          _push(`<button aria-label="Schritt ausw\xE4hlen" class="flex flex-col gap-4 items-center justify-center w-1/3 py-10"><div class="${ssrRenderClass([[unref(state).currentStep === step.id ? "bg-gold" : "bg-darkOffwhite"], "w-full h-[5px] rounded relative"])}"><div class="${ssrRenderClass([[
            unref(state).currentStep === step.id ? "bg-gradient-to-b from-gold via-lightGold to-darkGold" : "bg-darkOffwhite"
          ...
          _push(`</div></div><div class="${ssrRenderClass([[unref(state).currentStep === step.id ? "text-black font-bold" : "text-lightGrey"], ""])}" class="">${ssrInterpolate(step.name)}</div></button>`);
        });
        _push(`<!--]--></div>`);
...
//# sourceMappingURL=BookingCalendar-71e5a50d.mjs.map
