import _sfc_main$4 from './nuxt-icon-Cyx4B1z0.mjs';
...
import { v as vOnClickOutside } from './index-DD0SuucI.mjs';
import { d as defaults$1 } from './defaults-CgFcJQec.mjs';
import { u as useAsyncData, r as refreshNuxtData } from './asyncData-Dd4ONGX9.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="flex items-center gap-2"><span class="border border-darkGrey px-2 rounded">${ssrInterpolate(getDateString(_ctx.booking.start))}</span> - <span class="border border-darkGrey px-2 rounded">${ssrInterpolate(getDateString(_ctx.booking.end))}</span></div></button>`);
      if (unref(state).isOpen) {
...
//# sourceMappingURL=buchungen-Cy7GzM8t.mjs.map
