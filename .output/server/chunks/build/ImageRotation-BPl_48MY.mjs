              ...
              return [
                createVNode("div", { class: "px-2" }, [
                  ...
                  withDirectives(createVNode("input", {
                    ...
                    "onUpdate:modelValue": ($event2) => slide.text = $event2,
                    type: "text",
                  ...
                  withDirectives(createVNode("input", {
                    onChange: unref(saveContent),
                    "onUpdate:modelValue": ($event2) => slide.link = $event2,
                    type: "text",
                    class: "w-full rounded-sm pl-1 bg-transparent border border-darkOffwhite border-opacity-20 mb-4"
                  }, null, 40, ["onChange", "onUpdate:modelValue"]), [
                  ...
                  withDirectives(createVNode("input", {
                    onChange: unref(saveContent),
                    "onUpdate:modelValue": ($event2) => slide.image = $event2,
                    type: "text",
                    class: "w-full rounded-sm pl-1 bg-transparent border border-darkOffwhite border-opacity-20 mb-4"
                  }, null, 40, ["onChange", "onUpdate:modelValue"]), [
                  ...
                  withDirectives(createVNode("textarea", {
                    onChange: unref(saveContent),
                    "onUpdate:modelValue": ($event2) => slide.description = $event2,
                    rows: "4",
...
//# sourceMappingURL=ImageRotation-BPl_48MY.mjs.map
