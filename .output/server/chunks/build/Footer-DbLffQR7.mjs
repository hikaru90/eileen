import { reactive, mergeProps, unref, useSSRContext, defineComponent, withAsyncContext, computed } from 'vue';
...
import { a as useAuthStore, c as useContentStore, b as useSidebarStore, u as usePocketBase } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="max-container"><div class="flex flex-col md:flex-row justify-between gap-10"><div class="w-full md:w-1/5"><h2 class="font-bold opacity-60 mb-2 md:mb-6">Kontakt<br></h2><p style="${ssrRenderStyle({ "line-height": "37px" })}" class=""> Eileen George<br> Werkstra\xDFe 5 <br> 24955 Harrislee<br> kontakt@eileengeorge.de<br> +49 1525 140 2928<br></p></div><!--[-->`);
      ...
      _push(`<!--]--></div><div class="mt-16 text-sm flex justify-between"><span class="opacity-60"> \xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} \u2014 Eileen George </span><div>`);
...
//# sourceMappingURL=Footer-DbLffQR7.mjs.map
