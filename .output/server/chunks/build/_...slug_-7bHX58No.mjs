...
import { _ as __nuxt_component_1 } from './BlockRenderer-CFTlCqqT.mjs';
import _sfc_main$2 from './nuxt-icon-Cyx4B1z0.mjs';
import { _ as _sfc_main$3 } from './Container-CnlhW5wE.mjs';
import { u as usePocketBase, a as useAuthStore, b as useSidebarStore, c as useContentStore, s as storeToRefs, d as useRoute, e as useNuxtApp } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { pending, data: pageContent } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("pageContent", async () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(state).storePending) {
        ...
        _push(ssrRenderComponent(_component_Adder, {
          onAddBlock: ($event2) => addBlockContainer(0),
          onAddComponent: ($event2) => addComponent(0),
        ...
        if ((_a = unref(page)) == null ? void 0 : _a.expand) {
          ...
          ssrRenderList(unref(page).expand.containers, (container, index) => {
            ...
            _push(ssrRenderComponent(_component_Adder, {
              onAddBlock: ($event2) => addBlockContainer(index + 1),
              onAddComponent: ($event2) => addComponent(index + 1),
              displayComponentOption: ""
            }, null, _parent));
            _push(`</div>`);
          });
...
//# sourceMappingURL=_...slug_-7bHX58No.mjs.map
