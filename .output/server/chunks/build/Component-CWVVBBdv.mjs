...
import { b as useSidebarStore, u as usePocketBase, s as storeToRefs, c as useContentStore } from './server.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
const Audio = `<script setup lang="ts">\r
...
const BookingCalendar = `<script setup lang="ts">\r
  ...
  <div class="max-container">\r
    <template v-if="state.formSubmitted">\r
      <div v-if="state.success" class="flex justify-center my-20">\r
        ...
        >\r
          Vielen Dank f\xFCr Deine Buchung. <br />\r
      ...
      <div v-else class="flex justify-center my-20">\r
        ...
        >\r
          Bei der \xDCbermittlung Deiner Daten ist leider ein Fehler aufgetreten. <br />Versuch es\r
...
const ClickableHeadings = `<script setup lang="ts">\r
  import defaults from "~/lib/defaults";\r
...
const __vite_glob_0_2 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: ClickableHeadings
});
const Contact = `<script setup lang="ts">\r
  import defaults from "~/lib/defaults";\r
\r
  const config = useRuntimeConfig();\r
\r
  ...
  const validateForm = () => {\r
    ...
    for (let input of state.form) {\r
      if (input.validation === "required") {\r
        if (!input.value) {\r
          input.error = "F\xFClle bitte dieses Feld aus.";\r
          errors.push(1);\r
        } else input.error = "";\r
      }\r
    }\r
                ...
                <template v-else>\r
                  <template v-if="state.success">\r
                    ...
                    <p class="max-w-[24em]">\r
                      Deine Nachricht ist bei mir eingegangen. Ich melde mich sobald wie m\xF6glich bei\r
                      Dir.\r
                    </p>\r
                  </template>\r
                  <template v-else>\r
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const files = Object.keys(
      /* @__PURE__ */ Object.assign({ "/components/global/Component/Audio.vue": __vite_glob_0_0, "/components/global/Component/BookingCalendar.vue": __vite_glob_0_1, "/components/global/Component/ClickableHeadings.vue": __vite_glob_0_2, "/components/global/Component/Contact.vue": __vite_glob_0_3, "/components/global/Component/Default.vue": __vite_glob_0_4, "/components/global/Component/Downloads.vue": __vite_glob_0_5, "/components/global/Component/Faq.vue": __vite_glob_0_6, "/components/global/Component/HeroBig.vue": __vite_glob_0_7, "/components/global/Component/HeroSmall.vue": __vite_glob_0_8, "/components/global/Component/ImageList.vue": __vite_glob_0_9, "/components/global/Component/ImageRotation.vue": __vite_glob_0_10, "/components/global/Component/Map.vue": __vite_glob_0_11, "/components/global/Component/MyWork.vue": __vite_glob_0_12, "/components/global/Component/Offer.vue": __vite_glob_0_13, "/components/global/Component/PortraitText.vue": __vite_glob_0_14, "/components/global/Component/Prices.vue": __vite_glob_0_15, "/components/global/Component/Testimonials.vue": __vite_glob_0_16 })
    ).map((path) => {
...
//# sourceMappingURL=Component-CWVVBBdv.mjs.map
