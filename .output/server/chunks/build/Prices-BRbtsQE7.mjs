...
import { defineComponent, ref, computed, h, mergeProps, withCtx, createVNode, toDisplayString, useSSRContext } from 'vue';
import { u as useImage, p as parseSize } from './composables-Q-rs6X_2.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-28 mb-40" }, _attrs))}><div class="max-container"><div class="flex flex-col items-center justify-center mb-10">`);
      _push(ssrRenderComponent(_component_IntersectonPop, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b2;
          if (_push2) {
            _push2(`<h2 class="shiny-pop text-salmon font-bold text-lg md:text-xl lg:text-2xl mb-16"${_scopeId}>${ssrInterpolate((_a2 = props.component.content) == null ? void 0 : _a2.heading)}</h2>`);
          } else {
            return [
              createVNode("h2", { class: "shiny-pop text-salmon font-bold text-lg md:text-xl lg:text-2xl mb-16" }, toDisplayString((_b2 = props.component.content) == null ? void 0 : _b2.heading), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div><div class="flex flex-col md:flex-row gap-32 items-center justify-center mb-32"><!--[-->`);
      ssrRenderList((_a = props.component.content) == null ? void 0 : _a.prices, (card, index) => {
      ...
      _push(`<!--]--></div><div class="flex items-center justify-center"><p style="${ssrRenderStyle({ "max-width": "36em" })}" class="text-center text-sm">${ssrInterpolate((_b = props.component.content) == null ? void 0 : _b.subline)}</p></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=Prices-BRbtsQE7.mjs.map
