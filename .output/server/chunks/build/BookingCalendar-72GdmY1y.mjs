    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(state).formSubmitted) {
        ...
        ssrRenderList(unref(state).steps, (step, index) => {
          _push(`<button aria-label="Schritt ausw\xE4hlen" class="flex flex-col gap-4 items-center justify-center w-1/3 py-10"><div class="${ssrRenderClass([[unref(state).currentStep === step.id ? "bg-salmon/60" : "bg-darkOffwhite"], "w-full h-[5px] rounded relative"])}"><div class="${ssrRenderClass([[unref(state).currentStep === step.id ? "bg-salmon" : "bg-darkOffwhite"], "w-5 h-5 rounded-full absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2"])}">`);
...
//# sourceMappingURL=BookingCalendar-72GdmY1y.mjs.map
