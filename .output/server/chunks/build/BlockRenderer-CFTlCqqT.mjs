...
import { useSSRContext, defineComponent, reactive, computed, unref, createVNode, resolveDynamicComponent, withCtx, createTextVNode, mergeProps } from 'vue';
import { ssrRenderStyle, ssrRenderVNode, ssrRenderComponent, ssrRenderAttrs } from 'vue/server-renderer';
import { u as usePocketBase, a as useAuthStore, b as useSidebarStore, c as useContentStore, s as storeToRefs, e as useNuxtApp } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (props.depth === 0) {
        _push(ssrRenderComponent(_component_Adder, {
          onAddBlock: ($event2) => addBlock(props.block)
        }, {
...
//# sourceMappingURL=BlockRenderer-CFTlCqqT.mjs.map
