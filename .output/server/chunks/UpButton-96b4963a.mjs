...
import { defineComponent, withAsyncContext, reactive, computed, unref, withCtx, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext, mergeProps } from 'vue';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ], "fixed z-30 bg-white top-0 left-0 w-full h-full transform transition-all select-none"])}"><div class="max-container w-full"><div class="flex items-center justify-between py-6 mb-10"><div class="font-heading text-2xl">`);
      ...
      ssrRenderList(unref(menuEntries), (menuEntry, index) => {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          class: [[{ hidden: !menuEntry.slug }, unref(state).menuIsOpen ? "transition-all opacity-100" : "opacity-0"], "select-none flex items-center transition-all px-3 py-1 rounded duration-300"]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="font-bold"${_scopeId}>Jetzt Termin buchen</div><div class="flex items-center justify-center bg-gradient-to-b from-gold via-lightGold to-darkGold rounded-full ml-2 w-4 h-4"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "font-bold" }, "Jetzt Termin buchen"),
      ...
      _push(`</div></div></div><div class="absolute top-0 left-0 w-full shadow z-20 text-white"><div class="max-container w-full"><div class="flex items-center justify-between py-6"><div class="font-heading text-2xl">`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Eileen George `);
      ...
      _push(`</button></div><div class="hidden lg:block"><div class="flex items-center gap-4"><div class="flex items-center gap-4"><!--[-->`);
      ssrRenderList(unref(menuEntries), (menuEntry, index) => {
        _push(`<div style="${ssrRenderStyle(menuEntry.inMenu ? null : { display: "none" })}" class="relative">`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: menuEntry.slug === "index" ? "/" : menuEntry.slug,
        ...
        ], "absolute left-1 transform translate-y-full flex flex-col items-center -ml-3 transition-all"])}"><div class="bg-black bg-opacity-100 flex flex-col rounded shadow-lg px-2 py-2 mt-3 gap-2"><!--[-->`);
        ssrRenderList(menuEntry.expand.subpages, (subpage, i) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: subpage.slug === "index" ? "/" : subpage.slug,
            key: index + "subpage" + i,
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "text-shadow": "rgba(0, 0, 0, 0.8) 0 0 40px" })}" class=""${_scopeId}> Jetzt Termin buchen </div><div class="flex items-center justify-center bg-gradient-to-b from-gold via-lightGold to-darkGold rounded-full ml-2 w-4 h-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_nuxt_icon, {
              name: "icon-caret-right",
              class: "text-sm text-black"
            }, null, _parent2, _scopeId));
...
//# sourceMappingURL=UpButton-96b4963a.mjs.map
