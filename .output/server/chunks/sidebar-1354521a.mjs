import { _ as __nuxt_component_0, a as _sfc_main$3 } from './Footer-d530e466.mjs';
import { _ as _sfc_main$1, a as _sfc_main$2 } from './UpButton-96b4963a.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col h-full justify-between" }, _attrs))}><div class="flex flex-grow h-screen"><div id="content-container" class="flex flex-col flex-grow overflow-auto"><div class="flex flex-col flex-grow"><div>`);
      ...
      _push(`</div>`);
      if (unref(authStore).token) {
        _push(`<div class="bg-black w-96 text-darkOffwhite overflow-auto flex-shrink-0">`);
...
//# sourceMappingURL=sidebar-1354521a.mjs.map
