import{_ as I}from"./nuxt-icon.vue.b4bbe9a3.js";import{d as R}from"./defaults.fa42bbd5.js";import{a as h,k as y,W as w,s as k,o as n,f as e,F as T,j as $,x as j,u as l,i as _,h as U,t as P,V as E,m as F,p as D,l as b,c as z,Y as B}from"./entry.7d49cd86.js";const L=`<script setup lang="ts">\r
...
\r
      <div class="flex flex-col items-center gap-8 relative mb-32">\r
        <div\r
          ...
          :key="'audio' + index"\r
          class="w-full md:w-1/2 md:max-w-[500px] shadow-2xl shadow-coffee/30 rounded-lg overflow-hidden bg-white relative border border-coffee border-opacity-10"\r
        >\r
          <div\r
            class="mb-4 font-heading text-lg lg:text-xl flex items-center gap-4 border-b border-coffee border-opacity-10 px-6 py-4"\r
          >\r
            {{ audio.name }}\r
          </div>\r
          <div class="px-6 pt-3 pb-7">\r
            <div class="relative w-full h-full">\r
              ...
              <div\r
                :id="'audio' + index"\r
                class="inline-block ml-[60px] h-12 w-[calc(100%-124px)] overflow-hidden"\r
              ></div>\r
              <button\r
                v-if="state.audios.length > 0"\r
                @click="togglePlayPause(index)"\r
                class="inline-flex ml-[4px] w-[48px] h-[48px] items-center justify-center border border-coffee border-opacity-30 align-top rounded-lg"\r
              >\r
                <nuxt-icon\r
      ...
      <div class="relative">\r
        <form @submit.prevent="subscribe" class="flex items-center gap-4 justify-center">\r
          <input\r
            ...
            class="px-5 py-2 shadow-xl shadow-coffee/20 rounded-full flex-grow max-w-[300px] border border-coffee border-opacity-10"\r
          />\r
          <button\r
            @click="subscribe"\r
            :class="[{ 'pointer-events-none cursor-default': state.subscriptionPending }]"\r
            class="shadow-xl shadow-coffee/20 bg-coffee px-5 py-2 rounded-full text-white flex-shrink-0 flex items-center justify-center"\r
          >\r
...
\r
      <div class="flex flex-col md:flex-row itmes-stretch justify-center gap-16 relative">\r
        <div\r
          ...
          :key="'slide' + index"\r
          class="w-full md:w-1/2 md:max-w-[390px] shadow-2xl shadow-coffee/30 rounded-lg overflow-hidden border border-coffee border-opacity-10"\r
        >\r
...
`,J={class:"p-4"},K=["onClick"],Q=h({__name:"ComponentSelector",setup(f){const a=y(),s=w(),{setComponentContent:o,setComponentContentType:c,saveContent:u,saveContentType:d}=a,{decapitalize:m}=s,{componentContent:g,componentContentType:v}=k(a),x=r=>{c(r),o(R.find(t=>t.type===m(r)).content),u(!0),setTimeout(()=>{d(!0),E.emit("refresh")},500)},p=Object.keys(Object.assign({"/components/global/Component/Audio.vue":L,"/components/global/Component/BookingCalendar.vue":M,"/components/global/Component/Default.vue":V,"/components/global/Component/Faq.vue":G,"/components/global/Component/HeroBig.vue":N,"/components/global/Component/HeroSmall.vue":A,"/components/global/Component/ImageList.vue":W,"/components/global/Component/ImageRotation.vue":q,"/components/global/Component/MyWork.vue":O,"/components/global/Component/Offer.vue":X,"/components/global/Component/PortraitText.vue":H,"/components/global/Component/Prices.vue":Y,"/components/global/Component/Testimonials.vue":Z})).map(r=>{const t=r.split("/");return t[t.length-1].split(".")[0]});return(r,t)=>{const S=I;return n(),e("div",J,[(n(!0),e(T,null,$(l(p),(i,C)=>(n(),e("button",{key:"component"+C,onClick:rn=>x(i),class:j(["flex w-full items-center gap-2",[{"bg-white bg-opacity-20 rounded":l(v)===i}]])},[_(S,{name:`icon-${i}`,style:{"font-size":"60px"},class:"text-lightBlue"},null,8,["name"]),U("div",null,P(i),1)],10,K))),128))])}}}),nn={key:0},en={key:1},ln=h({__name:"Component",props:{selectedMode:{default:0}},emits:["setContentType"],setup(f,{emit:a}){const s=f,o=y();F();const{setComponentType:c}=o,{componentCss:u,componentContentType:d}=k(o),m=w(),{capitalize:g}=m;return D(()=>{c("component")}),(v,x)=>{const p=Q;return n(),e("div",null,[s.selectedMode===0?(n(),e("div",nn,[_(p,{class:"border-b border-darkOffwhite border-opacity-20"})])):b("",!0),s.selectedMode===1?(n(),e("div",en,[(n(),z(B("Sidebar"+l(g)(l(d)))))])):b("",!0)])}}});export{ln as default};
