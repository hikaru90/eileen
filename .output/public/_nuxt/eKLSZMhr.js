import{_ as F}from"./DR3C1UCQ.js";import{f as I,h as j,i as P,s as T,r as M,l as z,o as i,c as a,A as k,B as _,n as t,a as o,d as L,F as N,x as B,b as R,t as V,z as A,y as G,u as W,m as q,v as S,q as H,D as J}from"./BtqrO9Ir.js";import{d as C}from"./F1WjrixK.js";const X=`<script setup lang="ts">\r
...
`,Y=Object.freeze(Object.defineProperty({__proto__:null,default:X},Symbol.toStringTag,{value:"Module"})),K=`<script setup lang="ts">\r
...
\r
        const sendMailRes1 = await fetch("/api/mail/sendMail", {\r
          method: "POST",\r
          headers: {\r
            "Content-Type": "application/json",\r
          },\r
          body: JSON.stringify({\r
            template: "bookingRequestUser",\r
            recipient: payload.formValues.mail,\r
            formData: formData,\r
          }),\r
        });\r
        const sendMailRes2 = await fetch("/api/mail/sendMail", {\r
          method: "POST",\r
          headers: {\r
            "Content-Type": "application/json",\r
          },\r
          body: JSON.stringify({\r
            template: "bookingRequestOwner",\r
            recipient: "kontakt@eileengeorge.de",\r
            formData: formData,\r
          }),\r
        });\r
        const sendMailRes3 = await fetch("/api/mail/sendMail", {\r
          method: "POST",\r
          headers: {\r
            "Content-Type": "application/json",\r
          },\r
          body: JSON.stringify({\r
            template: "bookingRequestOwner",\r
            recipient: "alexbueckner@gmail.com",\r
            formData: formData,\r
          }),\r
        });\r
    ...
    <template v-else>\r
      <div class="flex items-center justify-center gap-10">\r
        ...
        >\r
          ...
          >\r
            <div\r
              :class="[state.currentStep === step.id ? 'bg-salmon' : 'bg-darkOffwhite']"\r
          ...
          <div :class="[state.currentStep === step.id ? 'text-coffee' : 'text-lightGrey']" class="">\r
            {{ step.name }}\r
          </div>\r
        </button>\r
      </div>\r
...
`,Z=Object.freeze(Object.defineProperty({__proto__:null,default:K},Symbol.toStringTag,{value:"Module"})),Q=`<script setup lang="ts">\r
  import defaults from "~/lib/defaults";\r
...
\r
      const sendMailRes = await fetch("/api/mail/sendMail", {\r
        method: "POST",\r
        headers: {\r
          "Content-Type": "application/json",\r
        },\r
        body: JSON.stringify({\r
          template: "contactForm",\r
          recipient: props.component.content?.recipient,\r
    ...
    <div class="max-container">\r
      ...
      <div class="flex flex-col lg:flex-row gap-16">\r
        ...
        <div class="-ml-[3%] -mr-[5%] lg:mx-auto w-auto lg:w-2/3">\r
          <div class="bg-white shadow-2xl shadow-coffee/20 py-5 px-10">\r
                ...
                <template v-else>\r
                  <template v-if="state.success">\r
                    ...
                    <p class="max-w-[24em]">\r
                      Deine Nachricht ist bei mir eingegangen. Ich melde mich sobald wie möglich bei\r
                      Dir.\r
                    </p>\r
                  </template>\r
                  <template v-else>\r
                    ...
                    <p class="max-w-[24em]">\r
                      Bei dem Versand Deiner Nachricht ist ein Fehler aufgetreten. Versuche es bitte\r
                      erneut. Falls der Fehler bestehen bleibt, sende mir bitte eine E-Mail an\r
                      <a href="mailto:kontakt@eileengeorge.de" class="underline"\r
                        >kontakt@eileengeorge.de</a\r
                      >.\r
                    </p>\r
                  </template>\r
                </template>\r
...
<template>\r
  <div class="bg-white pb-24 text-coffee">\r
    <div class="max-container">\r
      <div class="flex flex-col lg:flex-row gap-10">\r
        <div class="w-full flex gap-10 py-8 text-sm justify-around">\r
...
\r
            <NuxtLink v-if="offer.name === 'Find Your Way Home'"\r
                :to="\`mailto:kontakt@eileengeorge.de?subject=Auf Warteliste eintragen - \${offer.name}\`"\r
              ...
              >\r
                <div style="text-shadow: rgba(0, 0, 0, 0.8) 0 0 40px" class="">\r
                  Auf Warteliste eintragen\r
                </div>\r
              </NuxtLink>\r
              <NuxtLink v-else\r
                :to="\`mailto:kontakt@eileengeorge.de?subject=Terminvereinbarung - \${offer.name}\`"\r
                class="bg-salmon rounded-full text-white inline-flex items-center px-5 py-2 shadow-md"\r
              >\r
                <div style="text-shadow: rgba(0, 0, 0, 0.8) 0 0 40px" class="">\r
                  Termin vereinbaren\r
                </div>\r
              </NuxtLink>\r
          </div>\r
\r
...
`,ke=Object.freeze(Object.defineProperty({__proto__:null,default:we},Symbol.toStringTag,{value:"Module"})),_e=`<script setup lang="ts">\r
  import defaults from "~/lib/defaults";\r
  const config = useRuntimeConfig();\r
\r
  const props = withDefaults(\r
...
`,Se=Object.freeze(Object.defineProperty({__proto__:null,default:_e},Symbol.toStringTag,{value:"Module"})),Ce=`<script setup lang="ts">\r
  import defaults from "~/lib/defaults";\r
  const config = useRuntimeConfig();\r
\r
  const props = withDefaults(\r
...
`,Ie=Object.freeze(Object.defineProperty({__proto__:null,default:Ce},Symbol.toStringTag,{value:"Module"})),je=`<script setup lang="ts">\r
  import defaults from "~/lib/defaults";\r
  const config = useRuntimeConfig();\r
\r
  const props = withDefaults(\r
...
`,Pe=Object.freeze(Object.defineProperty({__proto__:null,default:je},Symbol.toStringTag,{value:"Module"})),Te={class:"p-4"},Re=o("div",{class:"font-bold mb-2"}," Content löschen? ",-1),De={class:"flex items-center justify-between mt-6"},$e=["onClick"],Oe=I({__name:"ComponentSelector",setup(v){const{$event:b}=G(),c=j(),m=P(),{setComponentContent:x,setComponentContentType:u,saveContent:f,saveContentType:g}=c,{decapitalize:d}=m,{componentContent:h,componentType:D,componentContentType:p}=T(c),s=M({modalVisible:!1,componentTypeStore:""}),$=r=>{if(console.log("isDefaultComponentContent.value",w.value),!w.value){s.modalVisible=!0,s.componentTypeStore=r;return}y(r)},y=r=>{console.log("changeType"),s.modalVisible=!1,u(r),x(C.find(e=>e.type===d(r)).content),f(!0),setTimeout(()=>{g(!0),b("refresh")},500)},O=(r,e)=>{try{const l=JSON.stringify(r,Object.keys(r).sort()),n=JSON.stringify(e,Object.keys(e).sort());return l===n}catch{return!0}},w=z(()=>{const r=C.find(l=>l.type===d(p.value)).content,e=JSON.parse(JSON.stringify(h.value));return!!O(r,e)}),U=Object.keys(Object.assign({"/components/global/Component/Audio.vue":Y,"/components/global/Component/BookingCalendar.vue":Z,"/components/global/Component/ClickableHeadings.vue":ee,"/components/global/Component/Contact.vue":ne,"/components/global/Component/Default.vue":se,"/components/global/Component/Downloads.vue":ie,"/components/global/Component/Faq.vue":ae,"/components/global/Component/HeroBig.vue":de,"/components/global/Component/HeroSmall.vue":me,"/components/global/Component/ImageList.vue":fe,"/components/global/Component/ImageRotation.vue":ve,"/components/global/Component/Map.vue":xe,"/components/global/Component/MyWork.vue":ye,"/components/global/Component/Offer.vue":ke,"/components/global/Component/PortraitText.vue":Se,"/components/global/Component/Prices.vue":Ie,"/components/global/Component/Testimonials.vue":Pe})).map(r=>{const e=r.split("/");return e[e.length-1].split(".")[0]});return(r,e)=>{const l=F;return i(),a("div",Te,[k(o("div",null,[Re,L(" Bist Du sicher, dass Du die Komponente austauschen möchtest? Der bisherige Content wird gelöscht. "),o("div",De,[o("button",{onClick:e[0]||(e[0]=n=>t(s).modalVisible=!1),class:"border border-red border-opacity-30 rounded px-2"}," Abbrechen "),o("button",{onClick:e[1]||(e[1]=n=>y(t(s).componentTypeStore)),class:"border bg-green border-green border-opacity-30 rounded px-4 py-1"}," Ja ")])],512),[[_,t(s).modalVisible]]),(i(!0),a(N,null,B(t(U),(n,E)=>k((i(),a("div",{key:"component"+E},[o("button",{onClick:Fe=>$(n),class:A(["flex w-full items-center gap-2",[{"bg-white bg-opacity-20 rounded":t(p)===n}]])},[R(l,{name:`icon-${n}`,style:{"font-size":"60px"},class:"text-lightBlue"},null,8,["name"]),o("div",null,V(n),1)],10,$e)])),[[_,!t(s).modalVisible]])),128))])}}}),Ue={key:0},Ee={key:1},Ne=I({__name:"Component",props:{selectedMode:{default:0}},emits:["setContentType"],setup(v,{emit:b}){const c=j();W();const{setComponentType:m}=c,{componentCss:x,componentContentType:u}=T(c),f=P(),{capitalize:g}=f,d=v;return q(()=>{m("component")}),(h,D)=>{const p=Oe;return i(),a("div",null,[d.selectedMode===0?(i(),a("div",Ue,[R(p,{class:"border-b border-darkOffwhite border-opacity-20"})])):S("",!0),d.selectedMode===1?(i(),a("div",Ee,[(i(),H(J("Sidebar"+t(g)(t(u)))))])):S("",!0)])}}});export{Ne as default};
