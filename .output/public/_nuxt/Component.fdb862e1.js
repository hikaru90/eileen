import{_ as F}from"./nuxt-icon.vue.5053ddd3.js";import{a as C,k as I,X as P,s as R,r as B,C as M,o as i,f as a,v as w,z as k,u as s,h as o,D as L,F as z,j as V,i as $,t as N,y as O,W as A,m as G,p as W,l as S,c as q,Z as H}from"./entry.fb780137.js";import{d as _}from"./defaults.24cc49a8.js";const J=`<script setup lang="ts">\r
...
\r
  const getCurrentImageUrl = (id, filename) => {\r
    const img = useImage();\r
    const imgUrl = img(\`\${config.SERVER_URL}/api/files/downloads/\${id}/\${filename}\`, {\r
      format: "webp",\r
    });\r
    return imgUrl;\r
  };\r
  ...
  <div class="py-16 md:py-24 relative">\r
    ...
    <div class="max-container h-full relative z-10">\r
      <div class="h-full flex items-center justify-center">\r
        ...
        <div class="flex-grow flex flex-col md:flex-row md:flex-wrap">\r
          <div\r
            v-if="state.newsletterSignupOpen"\r
            class="w-full md:w-1/2 shadow-2xl shadow-coffee/10 rounded-lg overflow-hidden bg-white relative border border-coffee border-opacity-10 py-4 px-5"\r
          >\r
            <h3 class="font-heading text-lg md:text-2xl mb-4 mt-1 ml-1">Datei herunterladen</h3>\r
            <p class="pl-1">\r
              Um diese Datei herunterzuladen, gib bitte Deine E-Mail-Adresse ein um Dich in meinem\r
              Newsletter einzutragen. Ich verwende Deine Daten ausschließlich um neue Meditationen\r
              und Inspiration mit Dir zu teilen. Ich werde Deine E-Mail-Adresse nicht für andere\r
              Zwecke verwenden oder weitergeben, versprochen.\r
            </p>\r
            <div class="relative">\r
              <form\r
          ...
          <div\r
            v-else\r
            v-for="(download, index) in downloads"\r
            :key="'audio' + index"\r
            class="w-full md:w-1/2 shadow-2xl shadow-coffee/10 rounded-lg overflow-hidden bg-white relative border border-coffee border-opacity-10 flex"\r
          >\r
            <div\r
              :style="[\r
              ...
              <div class="px-6 pt-1 pb-5">\r
                <div class="flex gap-10">\r
                  <div class="flex-grow">\r
                    ...
                    <button @click="handleDownload(download.id, download.file)" class="flex items-center justify-center flex-shrink-0 mt-4 mb-1">\r
                      <div\r
                        class="flex items-center justify-center gap-1 pl-3 pr-2 py-1 border border-grey/20 rounded-full hover:bg-salmon/80 text-coffee hover:text-white transition"\r
                      >\r
                        Herunterladen\r
...
`,mn={class:"p-4"},un=o("div",{class:"font-bold mb-2"}," Content löschen? ",-1),fn={class:"flex items-center justify-between mt-6"},gn=["onClick"],vn=C({__name:"ComponentSelector",setup(x){const m=I(),c=P(),{setComponentContent:d,setComponentContentType:u,saveContent:b,saveContentType:f}=m,{decapitalize:p}=c,{componentContent:g,componentType:D,componentContentType:v}=R(m),r=B({modalVisible:!1,componentTypeStore:""}),U=e=>{if(console.log("isDefaultComponentContent.value",y.value),!y.value){r.modalVisible=!0,r.componentTypeStore=e;return}h(e)},h=e=>{console.log("changeType"),r.modalVisible=!1,u(e),d(_.find(n=>n.type===p(e)).content),b(!0),setTimeout(()=>{f(!0),A.emit("refresh")},500)},E=(e,n)=>{try{const l=JSON.stringify(e,Object.keys(e).sort()),t=JSON.stringify(n,Object.keys(n).sort());return l===t}catch{return!0}},y=M(()=>{const e=_.find(l=>l.type===p(v.value)).content,n=JSON.parse(JSON.stringify(g.value));return!!E(e,n)}),T=Object.keys(Object.assign({"/components/global/Component/Audio.vue":J,"/components/global/Component/BookingCalendar.vue":X,"/components/global/Component/ClickableHeadings.vue":Z,"/components/global/Component/Contact.vue":K,"/components/global/Component/Default.vue":Y,"/components/global/Component/Downloads.vue":Q,"/components/global/Component/Faq.vue":nn,"/components/global/Component/HeroBig.vue":en,"/components/global/Component/HeroSmall.vue":rn,"/components/global/Component/ImageList.vue":tn,"/components/global/Component/ImageRotation.vue":sn,"/components/global/Component/Map.vue":on,"/components/global/Component/MyWork.vue":ln,"/components/global/Component/Offer.vue":an,"/components/global/Component/PortraitText.vue":cn,"/components/global/Component/Prices.vue":dn,"/components/global/Component/Testimonials.vue":pn})).map(e=>{const n=e.split("/");return n[n.length-1].split(".")[0]});return(e,n)=>{const l=F;return i(),a("div",mn,[w(o("div",null,[un,L(" Bist Du sicher, dass Du die Komponente austauschen möchtest? Der bisherige Content wird gelöscht. "),o("div",fn,[o("button",{onClick:n[0]||(n[0]=t=>s(r).modalVisible=!1),class:"border border-red border-opacity-30 rounded px-2"}," Abbrechen "),o("button",{onClick:n[1]||(n[1]=t=>h(s(r).componentTypeStore)),class:"border bg-green border-green border-opacity-30 rounded px-4 py-1"}," Ja ")])],512),[[k,s(r).modalVisible]]),(i(!0),a(z,null,V(s(T),(t,j)=>w((i(),a("div",{key:"component"+j},[o("button",{onClick:hn=>U(t),class:O(["flex w-full items-center gap-2",[{"bg-white bg-opacity-20 rounded":s(v)===t}]])},[$(l,{name:`icon-${t}`,style:{"font-size":"60px"},class:"text-lightBlue"},null,8,["name"]),o("div",null,N(t),1)],10,gn)])),[[k,!s(r).modalVisible]])),128))])}}}),xn={key:0},bn={key:1},Sn=C({__name:"Component",props:{selectedMode:{default:0}},emits:["setContentType"],setup(x,{emit:m}){const c=x,d=I();G();const{setComponentType:u}=d,{componentCss:b,componentContentType:f}=R(d),p=P(),{capitalize:g}=p;return W(()=>{u("component")}),(D,v)=>{const r=vn;return i(),a("div",null,[c.selectedMode===0?(i(),a("div",xn,[$(r,{class:"border-b border-darkOffwhite border-opacity-20"})])):S("",!0),c.selectedMode===1?(i(),a("div",bn,[(i(),q(H("Sidebar"+s(g)(s(f)))))])):S("",!0)])}}});export{Sn as default};
