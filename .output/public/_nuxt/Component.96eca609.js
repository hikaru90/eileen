import{_ as P}from"./nuxt-icon.vue.2e5ae816.js";import{a as C,k as I,W as $,s as R,r as B,B as M,o as i,f as a,q as w,y as k,u as s,h as o,C as N,F as V,j as z,i as T,t as L,x as O,V as G,m as A,p as q,l as _,c as W,Y as H}from"./entry.e5944ccf.js";import{d as S}from"./defaults.6c4b5884.js";const J=`<script setup lang="ts">\r
  ...
  const validateForm = () => {\r
    ...
    for (let input of state.form) {\r
      if (input.validation === "required") {\r
        if (!input.value) {\r
          input.error = "Füllen Sie bitte dieses Feld aus.";\r
          errors.push(1);\r
        } else input.error = "";\r
      }\r
    }\r
                  ...
                  <template v-else>\r
                    <template v-if="state.success">\r
                      ...
                      <p class="max-w-[24em]">\r
                        Ihre Nachricht ist bei mir eingegangen. Ich melde mich sobald wie möglich bei Ihnen.\r
                      </p>\r
                    </template>\r
                    <template v-else>\r
    ...
    <div class="max-container h-full relative z-10">\r
      <div class="h-full flex items-center justify-center">\r
        <div class="mt-10 mb-10">\r
          <h2\r
            style="max-width: 15em"\r
            class="text-coffee font-heading text-2xl sm:text-5xl md:text-5xl lg:text-6xl  text-center"\r
            v-html="$mdRenderer.set({ html: true }).render(props.component.content.heading)"\r
          >\r
          </h2>\r
...
`,mn={class:"p-4"},pn=o("div",{class:"font-bold mb-2"}," Content löschen? ",-1),fn={class:"flex items-center justify-between mt-6"},un=["onClick"],gn=C({__name:"ComponentSelector",setup(x){const p=I(),c=$(),{setComponentContent:d,setComponentContentType:f,saveContent:b,saveContentType:u}=p,{decapitalize:m}=c,{componentContent:g,componentType:F,componentContentType:v}=R(p),r=B({modalVisible:!1,componentTypeStore:""}),j=e=>{if(console.log("isDefaultComponentContent.value",y.value),!y.value){r.modalVisible=!0,r.componentTypeStore=e;return}h(e)},h=e=>{console.log("changeType"),r.modalVisible=!1,f(e),d(S.find(n=>n.type===m(e)).content),b(!0),setTimeout(()=>{u(!0),G.emit("refresh")},500)},U=(e,n)=>{try{const l=JSON.stringify(e,Object.keys(e).sort()),t=JSON.stringify(n,Object.keys(n).sort());return l===t}catch{return!0}},y=M(()=>{const e=S.find(l=>l.type===m(v.value)).content,n=JSON.parse(JSON.stringify(g.value));return!!U(e,n)}),D=Object.keys(Object.assign({"/components/global/Component/Audio.vue":J,"/components/global/Component/BookingCalendar.vue":X,"/components/global/Component/ClickableHeadings.vue":Y,"/components/global/Component/Contact.vue":K,"/components/global/Component/Default.vue":Z,"/components/global/Component/Faq.vue":Q,"/components/global/Component/HeroBig.vue":nn,"/components/global/Component/HeroSmall.vue":en,"/components/global/Component/ImageList.vue":rn,"/components/global/Component/ImageRotation.vue":tn,"/components/global/Component/Map.vue":sn,"/components/global/Component/MyWork.vue":on,"/components/global/Component/Offer.vue":ln,"/components/global/Component/PortraitText.vue":an,"/components/global/Component/Prices.vue":cn,"/components/global/Component/Testimonials.vue":dn})).map(e=>{const n=e.split("/");return n[n.length-1].split(".")[0]});return(e,n)=>{const l=P;return i(),a("div",mn,[w(o("div",null,[pn,N(" Bist Du sicher, dass Du die Komponente austauschen möchtest? Der bisherige Content wird gelöscht. "),o("div",fn,[o("button",{onClick:n[0]||(n[0]=t=>s(r).modalVisible=!1),class:"border border-red border-opacity-30 rounded px-2"}," Abbrechen "),o("button",{onClick:n[1]||(n[1]=t=>h(s(r).componentTypeStore)),class:"border bg-green border-green border-opacity-30 rounded px-4 py-1"}," Ja ")])],512),[[k,s(r).modalVisible]]),(i(!0),a(V,null,z(s(D),(t,E)=>w((i(),a("div",{key:"component"+E},[o("button",{onClick:bn=>j(t),class:O(["flex w-full items-center gap-2",[{"bg-white bg-opacity-20 rounded":s(v)===t}]])},[T(l,{name:`icon-${t}`,style:{"font-size":"60px"},class:"text-lightBlue"},null,8,["name"]),o("div",null,L(t),1)],10,un)])),[[k,!s(r).modalVisible]])),128))])}}}),vn={key:0},xn={key:1},kn=C({__name:"Component",props:{selectedMode:{default:0}},emits:["setContentType"],setup(x,{emit:p}){const c=x,d=I();A();const{setComponentType:f}=d,{componentCss:b,componentContentType:u}=R(d),m=$(),{capitalize:g}=m;return q(()=>{f("component")}),(F,v)=>{const r=gn;return i(),a("div",null,[c.selectedMode===0?(i(),a("div",vn,[T(r,{class:"border-b border-darkOffwhite border-opacity-20"})])):_("",!0),c.selectedMode===1?(i(),a("div",xn,[(i(),W(H("Sidebar"+s(g)(s(u)))))])):_("",!0)])}}});export{kn as default};
