import{_ as P}from"./nuxt-icon.vue.31f2b8d4.js";import{a as C,k as I,X as $,s as R,r as B,B as V,o as i,f as a,q as w,y as k,u as s,h as o,C as N,F as z,j as M,i as T,t as L,x as G,W as O,m as q,p as A,l as _,c as W,Z as H}from"./entry.bb92167b.js";import{d as S}from"./defaults.c2dccc6e.js";const J=`<script setup lang="ts">\r
...
`,mn={class:"p-4"},pn=o("div",{class:"font-bold mb-2"}," Content löschen? ",-1),fn={class:"flex items-center justify-between mt-6"},un=["onClick"],gn=C({__name:"ComponentSelector",setup(x){const p=I(),c=$(),{setComponentContent:d,setComponentContentType:f,saveContent:b,saveContentType:u}=p,{decapitalize:m}=c,{componentContent:g,componentType:j,componentContentType:v}=R(p),r=B({modalVisible:!1,componentTypeStore:""}),U=e=>{if(console.log("isDefaultComponentContent.value",y.value),!y.value){r.modalVisible=!0,r.componentTypeStore=e;return}h(e)},h=e=>{console.log("changeType"),r.modalVisible=!1,f(e),d(S.find(n=>n.type===m(e)).content),b(!0),setTimeout(()=>{u(!0),O.emit("refresh")},500)},F=(e,n)=>{try{const l=JSON.stringify(e,Object.keys(e).sort()),t=JSON.stringify(n,Object.keys(n).sort());return l===t}catch{return!0}},y=V(()=>{const e=S.find(l=>l.type===m(v.value)).content,n=JSON.parse(JSON.stringify(g.value));return!!F(e,n)}),D=Object.keys(Object.assign({"/components/global/Component/Audio.vue":J,"/components/global/Component/BookingCalendar.vue":X,"/components/global/Component/ClickableHeadings.vue":Z,"/components/global/Component/Contact.vue":K,"/components/global/Component/Default.vue":Y,"/components/global/Component/Faq.vue":Q,"/components/global/Component/HeroBig.vue":nn,"/components/global/Component/HeroSmall.vue":en,"/components/global/Component/ImageList.vue":rn,"/components/global/Component/ImageRotation.vue":tn,"/components/global/Component/Map.vue":sn,"/components/global/Component/MyWork.vue":on,"/components/global/Component/Offer.vue":ln,"/components/global/Component/PortraitText.vue":an,"/components/global/Component/Prices.vue":cn,"/components/global/Component/Testimonials.vue":dn})).map(e=>{const n=e.split("/");return n[n.length-1].split(".")[0]});return(e,n)=>{const l=P;return i(),a("div",mn,[w(o("div",null,[pn,N(" Bist Du sicher, dass Du die Komponente austauschen möchtest? Der bisherige Content wird gelöscht. "),o("div",fn,[o("button",{onClick:n[0]||(n[0]=t=>s(r).modalVisible=!1),class:"border border-red border-opacity-30 rounded px-2"}," Abbrechen "),o("button",{onClick:n[1]||(n[1]=t=>h(s(r).componentTypeStore)),class:"border bg-green border-green border-opacity-30 rounded px-4 py-1"}," Ja ")])],512),[[k,s(r).modalVisible]]),(i(!0),a(z,null,M(s(D),(t,E)=>w((i(),a("div",{key:"component"+E},[o("button",{onClick:bn=>U(t),class:G(["flex w-full items-center gap-2",[{"bg-white bg-opacity-20 rounded":s(v)===t}]])},[T(l,{name:`icon-${t}`,style:{"font-size":"60px"},class:"text-lightBlue"},null,8,["name"]),o("div",null,L(t),1)],10,un)])),[[k,!s(r).modalVisible]])),128))])}}}),vn={key:0},xn={key:1},kn=C({__name:"Component",props:{selectedMode:{default:0}},emits:["setContentType"],setup(x,{emit:p}){const c=x,d=I();q();const{setComponentType:f}=d,{componentCss:b,componentContentType:u}=R(d),m=$(),{capitalize:g}=m;return A(()=>{f("component")}),(j,v)=>{const r=gn;return i(),a("div",null,[c.selectedMode===0?(i(),a("div",vn,[T(r,{class:"border-b border-darkOffwhite border-opacity-20"})])):_("",!0),c.selectedMode===1?(i(),a("div",xn,[(i(),W(H("Sidebar"+s(g)(s(u)))))])):_("",!0)])}}});export{kn as default};
