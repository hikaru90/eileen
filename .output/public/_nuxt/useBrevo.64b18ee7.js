import{e as y}from"./entry.714c7b7e.js";const k=(s,e)=>{var i,n,l,g,c,r,h,u,d,t,$,p;return y(),[{name:"contactForm",subject:"Neue Kontaktanfrage",content:`<html><body>
      Liebe Eileen,<br /><br />
      ...
      </body></html>`}].find(N=>N.name===s)};function v(){const s=y();return{sendMail:async(b,i,n)=>{if(!(await fetch("https://api.brevo.com/v3/smtp/email",{method:"POST",headers:{accept:"application/json","api-key":s.public.BREVO_API_KEY,"content-type":"application/json"},body:JSON.stringify({sender:{email:"kontakt@eileengeorge.de",name:"Eileen George"},replyTo:{email:"kontakt@eileengeorge.de",name:"Eileen George"},to:[{email:i,name:`${n.firstName} ${n.lastName}`}],subject:k(b,n).subject,htmlContent:k(b,n).content})})).ok)return"Message could not be sent at this time."}}}export{v as u};
